...
│   │
│   └── 📂 resources/                       # 资源文件（预留）
│       └── 📄 __init__.py                  # 当前资源内容集成在main_window.py
│
├── 📂 test_images/                         # 测试图像目录
│
...
- 已删除冗余的占位模块（roi_selector, help_window, logger, config等）
- 所有功能完整可用，代码结构清晰
- 版本：v4.0.0（2025-11-12）

## 🌟 完整实现的模块

1. **main_window.py** (~2088行)
   - 主窗口完整实现
   - UI界面和交互逻辑
   - 帮助文档（中英文双语，集成在类方法中）
   - ROI选择功能
